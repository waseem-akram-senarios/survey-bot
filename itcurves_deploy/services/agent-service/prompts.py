...
VAPI_FUNCTION_RECORD_ANSWER = {
    "type": "function",
    "function": {
        "name": "record_answer",
        "description": "Record the rider's answer to a survey question. Call this after each question is answered.",
        "parameters": {
            "type": "object",
            "properties": {
                "question_id": {
                ...
                "raw_answer": {
                    "type": "string",
                    "description": "The rider's verbatim response"
                }
            },
...
VAPI_FUNCTION_END_SURVEY = {
    "type": "function",
    "function": {
        "name": "end_survey",
        "description": "End the survey. Call when all questions are done, time limit reached, or rider declines.",
        "parameters": {
            "type": "object",
            "properties": {
                "summary": {
                    "type": "string",
                    "description": "Brief summary of the survey interaction"
                },
                "status": {
                    "type": "string",
                    "enum": ["completed", "partial", "declined", "callback_requested", "timeout"],
                    "description": "Final status of the survey"
                }
            },
