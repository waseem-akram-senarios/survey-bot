...
from prompts import autofill_prompt, filtering_prompt, parse_prompt, sympathize_prompt
...
async def process_question(question, biodata):
    ...
    if choice == "Yes":  # i.e. question is relevant
        ...
        if que_criteria == "scale":
            ...
            filled = summarize(question.QueText, biodata)
        ...
        return SurveyQuestionAnswerP(
            ...
            Ans=filled or "None of the above",
            RawAns="",
