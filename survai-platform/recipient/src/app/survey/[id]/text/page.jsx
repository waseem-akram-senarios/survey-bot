...
export default function TextSurveyPage() {
  ...
  // Header submit handler - handles submission from header button
  ...
  const handleSurveyCompletion = async (startTime = sessionStartTime) => {
    try {
      ...
      console.log("Session started at:", new Date(startTime || sessionStartTime));
      console.log("Session ended at:", new Date());
