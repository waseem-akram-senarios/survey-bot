...
const TemplateHeader = ({
  ...
  const getTitle = () => {
    if (viewMode) return "Template Form";
    if (editMode) return "Edit Template";
    return "Create Template Form";
  };
    ...
    >
      ...
      {viewMode ? (
        <Box sx={{ display: "flex", gap: 1 }}>
          ...
          >
            <img src={AnalyticsIcon} alt="Analytics Icon" style={{ marginRight: "8px" }} />
            <Typography
              sx={{
                fontFamily: "Poppins, sans-serif",
                fontWeight: 400,
